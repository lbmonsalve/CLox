...
#define VM_EST(name, data, count) \
  UTEST_I(VM_, name, count) { \
...
VM_EST(PrintScript, printScript, 1);
...
VM_EST(OpConstant, opConstant, 4);
...
VM_EST(OpLiterals, opLiterals, 3);
...
VM_EST(OpAddConcat, opAddConcat, 7);
...
VM_EST(OpAddCConcat, opAddCConcat, 7);
...
VM_EST(OpSubtract, opSubtract, 4);
...
VM_EST(OpSubtractC, opSubtractC, 4);
...
VM_EST(OpMultiply, opMultiply, 4);
...
VM_EST(OpJumpIfFalse, opJumpIfFalse, 3);
...
VM_EST(OpPjmpIfFalse, opPjmpIfFalse, 3);
...
VM_EST(StringsIndex, stringsIndex, 4);
...
VM_EST(StringsParseNum, stringsParseNum, 3);
...
VM_EST(StringsSize, stringsSize, 3);
...
VM_EST(StringsSubstr, stringsSubstr, 10);
...
VM_EST(ClassesIndex, classesIndex, 9);
...
VM_EST(ClassesMethods, classesMethods, 4);
...
VM_EST(ClassesSuper, classesSuper, 4);
...
VM_EST(NativeArgc, nativeArgc, 2);
...
VM_EST(NativeArgv, nativeArgv, 3);

UTEST(VM_, NativeArgs) {
  MemBuffer out, err;
  VM vm;
  initMemBuffer(&out);
  initMemBuffer(&err);
...
VM_EST(NativeCeil, nativeCeil, 3);
...
VM_EST(NativeClock, nativeClock, 2);
...
VM_EST(NativeEprint, nativeEprint, 2);
...
VM_EST(NativeExit, nativeExit, 5);
...
VM_EST(NativeFloor, nativeFloor, 3);
...
VM_EST(NativeRound, nativeRound, 3);
...
VM_EST(NativeType, nativeType, 6);

UTEST(VM_, NativeTypeUpvalue) {
  MemBuffer out, err;
  VM vm;
  initMemBuffer(&out);
  initMemBuffer(&err);
